...
<link rel="shortcut icon" href="./img/logo/play/logo-no-background.png"
	type="image/x-icon">
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top">
		<div class="container">
			...
			<button class="navbar-toggler collapsed" type="button"
				data-bs-toggle="collapse" data-bs-target="#myNavbar1"
				aria-controls="myNavbar1" aria-expanded="false"
			...
			<div class="navbar-collapse text-center collapse" id="myNavbar1">
				...
				<a href="Logout" class="nav-item nav-link"
					style="color: rgba(0, 0, 0, 0.719);"> <i
					class="fa-sharp fa-solid fa-user"></i> Log out
				</a>
												...
												<div class="modal-content">
													...
													<div class="modal-body">
														<form action="Modificar" method="post">
															<input type="text" value="profesor" name="q"
																hidden="hidden">
															<!--  -->
							...
							<div class="dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
									...
									<form action="/MiaKhademia/Insertar" method="Post">
										...
										<input type="text" placeholder="Codigo Idioma"
											name="codIdioma" class="d-block m-4" required="required">
										<!--  -->
